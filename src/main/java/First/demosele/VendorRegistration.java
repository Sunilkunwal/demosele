...
//        driver.findElement(By.cssSelector("#continue")).click();
		...
		System.out.println(driver.findElement(By.cssSelector(
				"body > section:nth-child(8) > form:nth-child(2) > div:nth-child(1) > div:nth-child(3) > p:nth-child(3)"))
				.getText());
		System.out.println(driver
				.findElement(By.cssSelector("div[class='col-4'] div p[class='text-danger text-xs mt-2']")).getText());
